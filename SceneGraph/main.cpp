...
Material material(shineness, ambient, diffuse, specular,lightDir, constant, linear, quadratic);
...
int main()
{
    ...
    Shader lightingShader("vertex_shader.txt", "fragment_shader.txt");
